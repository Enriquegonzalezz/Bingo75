  ...
  return (
    <button
      ...
      className={`
        ...
        ${
          seleccionado
            ? 'bg-[#ffd402] border-2 border-[#ffd402] shadow-lg scale-105 text-[#1d1d1b]'
            : 'bg-[#124723] border-2 border-[#68b258] hover:border-[#ffd402] hover:scale-102'
        }
      `}
    >
      {/* Grid del patrón */}
      ...
      {/* Nombre */}
      <span
        className={`text-xs font-semibold text-center ${seleccionado ? 'text-[#1d1d1b]' : 'text-white'}`}
      >
        {modalidad.nombre}
      </span>
    </button>
...
export function ConfiguracionModal({
  ...
  const actualizarCartonesIndividuales = (numeroRonda: number, cartones: number[]) => {
    setRondas((prev) =>
      prev.map((r) => (r.numero === numeroRonda ? { ...r, cartonesIndividuales: cartones } : r))
    );
  };
    ...
    >
      ...
      >
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
          {/* Selector de Ronda */}
          <div className="bg-[#f8df7e] rounded-xl p-4 mb-6">
            {/* Número de rondas - MÁS VISIBLE */}
            <div className="bg-[#124723] rounded-lg p-3 mb-4 flex items-center justify-center gap-4">
              <span className="text-[#ffd402] font-black text-lg">NÚMERO DE RONDAS:</span>
              <div className="flex items-center gap-2">
                <button
                  onClick={() => handleNumeroRondasChange(numeroRondas - 1)}
                  disabled={numeroRondas <= 1}
                  className="w-10 h-10 bg-[#ffd402] text-[#000] font-black text-xl rounded-lg  disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  -
                </button>
                <input
                  ...
                  min={1}
                  max={20}
                  className="w-20 h-10 px-2 rounded-lg text-center font-black text-2xl border-2 border-[#f8df7e]"
                />
                <button
                  onClick={() => handleNumeroRondasChange(numeroRondas + 1)}
                  ...
                  className={`
                    ...
                    ${
                      rondaSeleccionada === ronda.numero
                        ? 'bg-[#124723] text-[#ffd402] scale-105'
                        : 'bg-[#f8df7e] text-[#124723] '
                    }
                  `}
                >
                  <span>Ronda {ronda.numero}</span>
                  {ronda.modalidades.length > 0 ? (
                    <span className="bg-[#1d1d1b] text-white text-xs px-2 py-0.5 rounded-full">
                      ✓
                    </span>
                  ) : (
            ...
            <div className="flex items-center gap-4 mt-3 pt-3 border-t border-[#ffd402]/30 flex-wrap">
              ...
              {/* Moneda de la ronda */}
              <div className="flex items-center gap-2 bg-[#124723] rounded-lg px-3 py-1 h-10">
                <span className="text-[#f8df7e] font-bold text-sm">Moneda:</span>
                <button
              ...
              {/* Premio de la ronda */}
              <div className="flex items-center gap-2 bg-[#124723] rounded-lg px-3 py-1 h-10">
                <span className="text-[#f8df7e] font-bold text-sm">💰 Premio:</span>
                <span className="text-[#f8df7e] font-bold">
          ...
          <div className="flex items-center justify-start gap-2 mb-4">
            {/* <div className="flex items-center gap-1 mr-4">
              <span className="text-2xl font-black text-[#1d1d1b]">1</span>
                  ...
                  className={`
                    ...
                    ${
                      categoriaActiva === cat.key
                        ? 'bg-[#124723] text-[#ffd402]'
                        : 'bg-white text-[#124723] border-2 border-[#124723] hover:bg-[#124723] hover:text-[#ffd402]'
                    }
                  `}
                >
                  {cat.label}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg p-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-[#124723] to-[#1a5c2f] rounded-lg p-4">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border-2 border-[#ffd402] rounded-lg focus:ring-2 focus:ring-[#ffd402] focus:border-transparent font-bold text-[#1d1d1b] bg-[#f8df7e]"
                  >
                  ...
                  <p className="text-xs text-[#f8df7e] mt-2">
                ...
                {usarCartonesEspecificos && (
                  <div className="bg-[#124723] rounded-lg p-4 mt-2">
                    <h4 className="text-[#ffd402] font-bold mb-2 text-sm">
                      Cartones Específicos para Ronda {rondaSeleccionada}
                    </h4>
                    <p className="text-[#f8df7e] text-xs mb-3">
                      Si deseas que solo participen ciertos cartones en esta ronda, agrega sus
                      números aquí, si no se agrega ninguno utilizará el rango general.
                    </p>
                    ...
                    <div className="flex gap-2 mb-3">
                      <input
                        ...
                        className="flex-1 px-3 py-2 rounded-lg border-2 border-[#68b258] text-[#1d1d1b] font-semibold text-sm bg-[#fff]"
                      />
                      <button
                    ...
                    {rondaActual?.cartonesIndividuales &&
                      rondaActual.cartonesIndividuales.length > 0 && (
                        <div className="bg-[#1d1d1b] rounded-lg p-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {rondaActual.cartonesIndividuales.map((carton) => (
                              <div
                                key={carton}
                                className="bg-[#124723] text-[#ffd402] px-3 py-1 rounded-full text-sm font-bold flex items-center gap-2"
                              >
                                #{carton}
                                <button
                                  onClick={() =>
              ...
              className={`
                ...
                ${
                  !todasRondasTienenModalidades
                    ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                    : 'bg-[#124723] text-[#ffd402] hover:bg-[#1a5c2f]'
                }
              `}
            >
